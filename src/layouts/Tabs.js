...
const Tabs = (props) =>{
    ...
    const ActiveStyle = { background: "radial-gradient( circle closest-side, rgb(0,0,0), rgb(100,100,100)) " 
                            , margin:"1em 0.2em 0 0.2em" , 
                            textAlign: "center"
                        }
    return(
            <div className="container">
                 <div className="row" style={{ marginTop: "-3em", justifyContent: "space-evenly"}}>
                    <motion.div 
                        className="col-lg-5"
                        whileTap={{ scale: 0.8 }}
                        >
